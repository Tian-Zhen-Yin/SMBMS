                ...
                <tr class="firstTr">
                   ...
                   <c:forEach var="user" items="${list }" varStatus="status">
					<tr>
						...
						<span><a class="deleteUser" href="javascript:;" userid=${user.id } username=${user.userName } nowUser=${userSession.id }><img src="${pageContext.request.contextPath }/statics/images/schu.png" alt="删除" title="删除"/></a></span>
						</td>
					</tr>
				</c:forEach>
			</table>
